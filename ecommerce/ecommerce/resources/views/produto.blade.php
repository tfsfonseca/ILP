        ...
        <div class="grid grid-cols-1 gap-1">
            ...
            <div class="max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 mr-2">
                ...
                <div class="px-5 pb-5">
                    ...
                    <h3 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white mb-5">
                        {{$produto->fornecedor->nomeEmpresa}}
                    </h3>
                    <div class="flex justify-between items-center">
                        <h5 class="text-xl font-semibold tracking-wider">
                            <span class="text-2xl font-bold text-gray-900 dark:text-white mr-2">{{"R$ "}}{{$produto->preco}}</span>
                        </h5>
                        <a href="{{route('carrinho')}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Comprar</a>
                    </div>
                </div>
            </div>
