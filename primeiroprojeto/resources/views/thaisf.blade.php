...
<div class="container">
    <div class="alert alert-success text-dark">
        <p>This is a test to see if the route is a problem.</p>
        <p class="text-muted">If you see this message, everything is working fine.</p>
        <p class="text-danger">You may delete it later.</p>
    </div>
</div>
